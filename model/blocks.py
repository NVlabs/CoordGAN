...
class ConvLayer_swap(nn.Sequential):
    def __init__(
        self,
        in_channel,
        out_channel,
        ...
        if downsample:
            ...
            layers.append(("Blur", Blur_swap(blur_kernel, pad=(pad0, pad1), reflection_pad=reflection_pad)))
...
class LFF(nn.Module):
    def __init__(self, hidden_size, in_ch=2):
        super(LFF, self).__init__()
        self.ffm = ConLinear(in_ch, hidden_size, is_first=True)
...
#class ModulatedConv2d_swap(nn.Module):
#    def __init__(
#        self,
#        in_channel,
#        out_channel,
...
#        )
#
#        self.modulation = EqualLinear_swap(style_dim, in_channel, bias_init=1)
#
#        self.demodulate = demodulate
...
#
#
#class StyledConv_swap(nn.Module):
#    def __init__(
#        self,
#        in_channel,
#        out_channel,
...
#        super().__init__()
#
#        self.conv = ModulatedConv2d_swap(
#            in_channel,
#            out_channel,
#            kernel_size,
#            style_dim,
